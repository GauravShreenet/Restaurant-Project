...
import com.example.resturantapp.databinding.ActivityPastaBinding;
...
public class Pasta extends DrawerBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Pasta.this, MyCart.class));
            }
        });
